...
import static map.test.yuja.example.jaewon.yujatest.LogManager.*;
import static map.test.yuja.example.jaewon.yujatest.R.*;

public class Intro extends BaseActivity implements onLocationChangedCallback {
    /**
    ...
    private static final int[] mArrayMapButton = {
            ...
            id.btnSetZoomLevel,
            id.btnSetMapType,
            id.btnGetLocationPoint,
            id.btnSetLocationPoint,
            id.btnSetIcon,
            id.btnSetCompassMode,
            id.btnGetIsCompass,
            id.btnSetTrafficInfo,
            id.btnGetIsTrafficeInfo,
            id.btnSetSightVisible,
            id.btnSetTrackIngMode,
            id.btnGetIsTracking,
            id.btnAddTMapCircle,
            id.btnRemoveTMapCircle,
            id.btnMarkerPoint,
            id.btnRemoveMarker,
            id.btnMoveFrontMarker,
            id.btnMoveBackMarker,
            id.btnDrawPolyLine,
            id.btnErasePolyLine,
            id.btnDrawPolygon,
            id.btnErasePolygon,
            id.btnBicycle,
            id.btnBicycleFacility,
            id.btnMapPath,
            id.btnRemoveMapPath,
            id.btnDisplayMapInfo,
            id.btnNaviGuide,
            id.btnCarPath,
            id.btnPedestrian_Path,
            id.btnBicycle_Path,
            id.btnGetCenterPoint,
            id.btnFindAllPoi,
            id.btnConvertToAddress,
            id.btnGetBizCategory,
            id.btnGetAroundBizPoi,
            id.btnTileType,
            id.btnCapture,
            id.btnDisalbeZoom,
            id.btnInvokeRoute,
            id.btnInvokeSetLocation,
            id.btnInvokeSearchPortal,
            id.btnTimeMachine,
            id.btnTMapInstall,
            id.btnMarkerPoint2,
            id.btnGotoFaceBook,
...
//		});
        ...
        mMapView.setOnCalloutRightButtonClickListener(new TMapView.OnCalloutRightButtonClickCallback() {
            ...
            public void onCalloutRightButton(TMapMarkerItem markerItem) {
                ...
                Common.showAlertDialog(Intro.this, "Callout Right Button", strMessage);
            }
        });
        ...
        mMapView.setOnClickReverseLabelListener(new TMapView.OnClickReverseLabelListenerCallback() {
            ...
            public void onClickReverseLabelEvent(TMapLabelInfo findReverseLabel) {
                if (findReverseLabel != null) {
                    LogManager.printLog("Intro setOnClickReverseLabelListener " + findReverseLabel.id + " / " + findReverseLabel.labelLat
...
//		gps.CloseGps();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case id.btnZoomOut:
                mapZoomOut();
                break;
            case id.btnGetZoomLevel:
                getZoomLevel();
                break;
            case id.btnSetZoomLevel:
                setZoomLevel();
                break;
            case id.btnSetMapType:
                setMapType();
                break;
            case id.btnGetLocationPoint:
                getLocationPoint();
                break;
            case id.btnSetLocationPoint:
                setLocationPoint();
                break;
            case id.btnSetIcon:
                setMapIcon();
                break;
            case id.btnSetCompassMode:
                setCompassMode();
                break;
            case id.btnGetIsCompass:
                getIsCompass();
                break;
            case id.btnSetTrafficInfo:
                setTrafficeInfo();
                break;
            case id.btnGetIsTrafficeInfo:
                getIsTrafficeInfo();
                break;
            case id.btnSetTrackIngMode:
                setTrackingMode();
                break;
            case id.btnGetIsTracking:
                getIsTracking();
                break;
            case id.btnAddTMapCircle:
                addTMapCircle();
                break;
            case id.btnRemoveTMapCircle:
                removeTMapCircle();
                break;
            case id.btnMarkerPoint:
                showMarkerPoint();
                break;
            case id.btnRemoveMarker:
                removeMarker();
                break;
            case id.btnMoveFrontMarker:
                moveFrontMarker();
                break;
            case id.btnMoveBackMarker:
                moveBackMarker();
                break;
            case id.btnMapPath:
                drawMapPath();
                break;
            case id.btnRemoveMapPath:
                removeMapPath();
                break;
            case id.btnDisplayMapInfo:
                displayMapInfo();
                break;
            case id.btnNaviGuide:
                naviGuide();
                break;
            case id.btnPedestrian_Path:
                drawPedestrianPath();
                break;
            case id.btnBicycle_Path:
                drawBicyclePath();
                break;
            case id.btnConvertToAddress:
                convertToAddress();
                break;
            case id.btnTileType:
                setTileType();
                break;
            case id.btnInvokeRoute:
                invokeRoute();
                break;
            case id.btnInvokeSetLocation:
                invokeSetLocation();
                break;
            case id.btnInvokeSearchPortal:
                invokeSearchProtal();
                break;
            case id.btnBicycle:
                setBicycle();
                break;
            case id.btnBicycleFacility:
                setBicycleFacility();
                break;
            case id.btnCapture:
                captureImage();
                break;
            case id.btnDisalbeZoom:
                disableZoom();
                break;
            case id.btnTimeMachine:
                timeMachine();
                break;
            case id.btnTMapInstall:
                tmapInstall();
                break;
    ...
    public void overlay() {
        ...
        if (m_bOverlayMode) {
            ...
            mOverlay.setImage(BitmapFactory.decodeResource(mContext.getResources(), drawable.test_image));

            if (mOverlayList == null) {
                mOverlayList = new ArrayList<Bitmap>();
                mOverlayList.add(BitmapFactory.decodeResource(mContext.getResources(), drawable.test_image));
                mOverlayList.add(BitmapFactory.decodeResource(mContext.getResources(), drawable.ani1));
                mOverlayList.add(BitmapFactory.decodeResource(mContext.getResources(), drawable.ani2));
            }
...
//		Bitmap capture = mMapView.getCaptureImage();
    ...
    public void setZoomLevel() {
        final String[] arrString = getResources().getStringArray(array.a_zoomlevel);
        AlertDialog dlg = new AlertDialog.Builder(this)
                .setIcon(drawable.ic_launcher)
                .setTitle("Select Zoom Level")
                .setSingleChoiceItems(array.a_zoomlevel, m_nCurrentZoomLevel, new DialogInterface.OnClickListener() {
                    @Override
    ...
    public void setMapType() {
        AlertDialog dlg = new AlertDialog.Builder(this)
                ...
                .setSingleChoiceItems(array.a_maptype, -1, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int item) {
    ...
    public void setMapIcon() {
        ...
        if (m_bShowMapIcon) {
            Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), drawable.ic_launcher);
    ...
    public void showMarkerPoint2() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            marker1.setID(strID);
            marker1.setIcon(BitmapFactory.decodeResource(getResources(), drawable.map_pin_red));
            ...
            list.add(BitmapFactory.decodeResource(mContext.getResources(), drawable.map_pin_red));
            list.add(BitmapFactory.decodeResource(mContext.getResources(), drawable.end));
        ...
        mMapView.setOnMarkerClickEvent(new TMapView.OnCalloutMarker2ClickCallback() {
            ...
            public void onCalloutMarker2ClickEvent(String id, TMapMarkerItem2 markerItem2) {
                ...
                Common.showAlertDialog(Intro.this, "TMapMarker2", strMessage);
            }
        });
    }
...
////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////
        final String[] arrString = getResources().getStringArray(array.ducksugung);
        ...
        bitmap = BitmapFactory.decodeResource(mContext.getResources(), drawable.i_location);
        ...
        Bitmap bitmaps = BitmapFactory.decodeResource(mContext.getResources(), drawable.ic_launcher);
        item1.setCalloutLeftImage(bitmaps);
        Bitmap bitmap_i = BitmapFactory.decodeResource(mContext.getResources(), drawable.i_go);
        ...
        bitmap_i = BitmapFactory.decodeResource(mContext.getResources(), drawable.i_go);
        item2.setCalloutRightButtonImage(bitmap_i);

        bitmap = BitmapFactory.decodeResource(mContext.getResources(), drawable.pin_tevent);
        ...
        bitmap = BitmapFactory.decodeResource(mContext.getResources(), drawable.map_pin_red);
        item2.setIcon(bitmap);
        ...
        bitmap = BitmapFactory.decodeResource(mContext.getResources(), drawable.end);
        item2.setIcon(bitmap);
        ...
        for (int i = 4; i < 10; i++) {
            ...
            item3.setID(strID);
            item3.setIcon(BitmapFactory.decodeResource(getResources(), drawable.map_pin_red));
...
//		TMapPoint point2 = randomTMapPoint();
        ...
        tmapdata.findPathDataWithType(TMapPathType.BICYCLE_PATH, point1, point2,
...
//			});
    ...
    public void setTileType() {
        AlertDialog dlg = new AlertDialog.Builder(this)
                ...
                .setSingleChoiceItems(array.a_tiletype, -1, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int item) {
    ...
    public void invokeRoute() {
        ...
        if (mMapView.isValidTMapPoint(point)) {
            tmapdata.convertGpsToAddress(point.getLatitude(), point.getLongitude(), new ConvertGPSToAddressListenerCallback() {
                @Override
                public void onConvertToGPSToAddress(String strAddress) {
                    TMapTapi tmaptapi = new TMapTapi(Intro.this);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://map.test.yuja.example.jaewon.yujatest/http/host/path")
        );
