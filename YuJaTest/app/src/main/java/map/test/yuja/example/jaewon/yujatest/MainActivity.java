...
import static map.test.yuja.example.jaewon.yujatest.R.array;
import static map.test.yuja.example.jaewon.yujatest.R.drawable;
import static map.test.yuja.example.jaewon.yujatest.R.id;
import static map.test.yuja.example.jaewon.yujatest.R.layout;
